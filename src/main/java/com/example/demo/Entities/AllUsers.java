...
@AllArgsConstructor
@NoArgsConstructor
@DynamoDBTable(tableName = "AllUsers")
public class AllUsers {
	...
	public AllUsers(String type, String userName, String phoneNumber) throws NoSuchAlgorithmException {
		this.type = type;
	...
	public boolean equals(Object o) {
		if (o == this)
			return true;
		if (!(o instanceof AllUsers)) {
			return false;
		}
		AllUsers user = (AllUsers) o;
